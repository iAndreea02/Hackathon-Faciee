...
class InginerieElectricaPage(Screen):
    def __init__(self, **kwargs):
        ...
        lbl_nume = Label(text="Viitor Inginer Electrician", font_size='24sp', bold=True, color=COLOR_WHITE, halign='left')
        ...
        lbl_dip = Label(text="Inginer în Inginerie Electrică și Sisteme Energetice", color=COLOR_WHITE, font_size='17sp', bold=True, halign='left', valign='top')
        ...
        lbl_hero_t = Label(text="Energia care pune lumea în mișcare", font_size='22sp', bold=True, color=COLOR_WHITE, halign='left', size_hint_y=None, height=60)
        ...
        hero_desc = "Vei învăța cum funcționează motoarele, rețelele electrice, sursele regenerabile și infrastructura energetică modernă."
        ...
        # Stânga: MAGENTA
        opts = ["Energetică modernă", "Rețele Smart Grid", "Transport electric", "Case inteligente"]
        grid.add_widget(create_clean_card(COLOR_MAGENTA, "Oportunități", opts))

        # Dreapta: PURPLE
        learn = ["Bazele electricității", "Motoare electrice", "Surse regenerabile", "Electronică de putere"]
        ...
        msg_card.add_widget(Label(text="DE CE SĂ ALEGI EL?", color=COLOR_CYAN, bold=True, font_size='14sp', size_hint_y=None, height=25, halign='center'))
        
        txt_final = "Dacă îți place fizica aplicată și te fascinează ideea de a lucra cu energie și sisteme electrice, aici poți deveni inginerul care face lumea mai eficientă!"
