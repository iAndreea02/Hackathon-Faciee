...
class IetiPage(Screen):
    def __init__(self, **kwargs):
        ...
        lbl_nume = Label(text="Viitor Inginer ETC", font_size='26sp', bold=True, color=COLOR_WHITE, halign='left')
        ...
        info_card = RoundedCard(bg_color=COLOR_PURPLE, size_hint_y=None, height=120) # Putin mai inalt pentru text lung
        ...
        lbl_dip = Label(text="Inginer în Electronică, Telecomunicații și Tehnologii Informaționale", color=COLOR_WHITE, font_size='16sp', bold=True, halign='left', valign='top')
        ...
        lbl_hero_t = Label(text="Tehnologia care conectează lumea", font_size='22sp', bold=True, color=COLOR_WHITE, halign='left', size_hint_y=None, height=60)
        ...
        hero_desc = "Vei studia electronica modernă, comunicațiile digitale, antene, IoT, sisteme radar și proiectarea circuitelor integrate."
        ...
        # Stânga: MAGENTA
        opts = ["Telecomunicații", "Radio & Wireless", "Industrie Tech", "Dispozitive Smart"]
        grid.add_widget(create_clean_card(COLOR_MAGENTA, "Oportunități", opts))

        # Dreapta: PURPLE
        learn = ["Circuite electronice", "Rețele comunicații", "Antene & RF", "Internet of Things"]
        grid.add_widget(create_clean_card(COLOR_PURPLE, "Ce vei învăța", learn))
        ...
        msg_card.add_widget(Label(text="DE CE SĂ ALEGI ETC?", color=COLOR_CYAN, bold=True, font_size='14sp', size_hint_y=None, height=25, halign='center'))
        
        txt_final = "Dacă vrei să fii parte din tehnologia care conectează lumea – 5G, comunicații satelitare, IoT și dispozitive electronice – aici viitorul prinde formă."
